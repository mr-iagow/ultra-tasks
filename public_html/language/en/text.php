...
$hesklang['pass_reset_forced_all_button']='Force password reset on next login';
$hesklang['pass_reset_forced_all_title']='Force password reset for all users';
$hesklang['pass_reset_forced_all_confirm']='All users will be required to set a new password before they can access the system on their next login. Do you want to continue?';
$hesklang['pass_reset_forced_all_yes']='Force password reset';
$hesklang['pass_reset_forced_all']='All users will be required to change their password on their next login.';
$hesklang['pass_reset_required_notice']='For security reasons, you need to set a new password before continuing.';
...
$hesklang['require_ddh_approval']='Requires DDH approval';
$hesklang['require_auditoria_approval']='Requires Auditoria approval';
